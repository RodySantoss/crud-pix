...
//
//        when(pixKeyService.findAllPixKeys()).thenReturn(respDTO);
//
...
//        when(pixKeyService.findAllPixKeys()).thenThrow(new EntityNotFoundException("No Pix keys found"));
//
//        ResponseEntity<RespDTO> response = pixKeyController.findAll();
//
//        assertEquals(HttpStatus.NOT_FOUND, response.getStatusCode());
...
//        RespDTO respDTO = new RespDTO(HttpStatus.OK, pixKeyDTO);
//
//        when(pixKeyService.findPixKeyById(any(UUID.class))).thenReturn(respDTO);
//
...
//        UUID id = UUID.randomUUID();
//        when(pixKeyService.findPixKeyById(id)).thenThrow(new EntityNotFoundException("Pix key not found"));
//
//        ResponseEntity<RespDTO> response = pixKeyController.findById(id);
//
//        assertEquals(HttpStatus.NOT_FOUND, response.getStatusCode());
...
//        RespDTO respDTO = new RespDTO(HttpStatus.OK, pixKeysDTO);
//
//        when(pixKeyService.findPixKeysByType(keyType)).thenReturn(respDTO);
//
...
//        String keyType = "CPF";
//        when(pixKeyService.findPixKeysByType(keyType))
...
//        RespDTO respDTO = new RespDTO(HttpStatus.OK, pixKeysDTO);
//
//        when(pixKeyService.findPixKeysByAgencyAndAccount(any(Integer.class), any(Integer.class))).thenReturn(respDTO);
//
...
//        Integer account = 12345678;
//
//        when(pixKeyService.findPixKeysByAgencyAndAccount(any(Integer.class), any(Integer.class)))
//                .thenThrow(new EntityNotFoundException("There is no such account with this agency number and account"));
//
//        ResponseEntity<RespDTO> response = pixKeyController.findByAgencyAndAccount(agency, account);
//
...
//        RespDTO respDTO = new RespDTO(HttpStatus.OK, pixKeysDTO);
//
//        when(pixKeyService.findPixKeysByUserName(any(String.class))).thenReturn(respDTO);
//
...
//        String userName = "Joao";
//
//        when(pixKeyService.findPixKeysByUserName(any(String.class)))
...
//        RespDTO respDTO = new RespDTO(HttpStatus.OK, pixKeysDTO);
//
//        when(pixKeyService.findPixKeysByCreatedAt(any(LocalDate.class))).thenReturn(respDTO);
//
...
//        LocalDate createdAt = LocalDate.now();
//
//        when(pixKeyService.findPixKeysByCreatedAt(any(LocalDate.class)))
...
//        RespDTO respDTO = new RespDTO(HttpStatus.OK, pixKeysDTO);
//
//        when(pixKeyService.findPixKeysByInactivatedAt(any(LocalDate.class))).thenReturn(respDTO);
//
...
//        LocalDate inactivatedAt = LocalDate.now();
//
//        when(pixKeyService.findPixKeysByInactivatedAt(any(LocalDate.class)))
